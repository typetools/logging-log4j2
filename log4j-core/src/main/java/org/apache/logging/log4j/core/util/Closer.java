...
public final class Closer {
     ...
     */
    public static boolean close(final @Nullable AutoCloseable closeable) throws Exception {
        if (closeable != null) {
     ...
     */
    public static boolean closeSilently(final @Nullable AutoCloseable closeable) {
        try {
